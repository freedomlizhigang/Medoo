...
class Medoo
{
	...
	protected function selectContext(&$map, $join, &$columns = null, $where = null, $column_fn = null)
	{
		preg_match('/(?<table>[a-zA-Z0-9_]+)\s*\((?<alias>[a-zA-Z0-9_]+)\)/i', $this->table, $table_match);

		if (isset($table_match[ 'table' ], $table_match[ 'alias' ]))
		{
			$table = $this->tableQuote($table_match[ 'table' ]);

			$table_query = $this->table . ' AS ' . $this->tableQuote($table_match[ 'alias' ]);
		}
		else
		{
	...
	public function select($join, $columns = null, $where = null)
	{
		...
		$query = $this->exec($this->selectContext($map, $join, $columns, $where), $map);
	...
	public function insert($datas)
	{
		...
		return $this->exec('INSERT INTO ' . $this->tableQuote($this->table) . ' (' . implode(', ', $fields) . ') VALUES ' . implode(', ', $stack), $map);
	}
	...
	public function update($data, $where = null)
	{
		...
		return $this->exec('UPDATE ' . $this->tableQuote($this->table) . ' SET ' . implode(', ', $fields) . $this->whereClause($where, $map), $map);
	}
	...
	public function delete($where)
	{
		...
		return $this->exec('DELETE FROM ' . $this->tableQuote($this->table) . $this->whereClause($where, $map), $map);
	}
	...
	public function replace($columns, $where = null)
	{
		...
		return $this->exec('UPDATE ' . $this->tableQuote($this->table) . ' SET ' . $replace_query . $this->whereClause($where, $map), $map);
	}
	...
	public function get($join = null, $columns = null, $where = null)
	{
		...
		$query = $this->exec($this->selectContext($map, $join, $columns, $where) . ' LIMIT 1', $map);
	...
	public function has($join, $where = null)
	{
		...
		$query = $this->exec('SELECT EXISTS(' . $this->selectContext($map, $join, $column, $where, 1) . ')', $map);
	...
	public function count($join = null, $column = null, $where = null)
	{
		...
		$query = $this->exec($this->selectContext($map, $join, $column, $where, 'COUNT'), $map);
	...
	public function max($join, $column = null, $where = null)
	{
		...
		$query = $this->exec($this->selectContext($map, $join, $column, $where, 'MAX'), $map);
	...
	public function min($join, $column = null, $where = null)
	{
		...
		$query = $this->exec($this->selectContext($map, $join, $column, $where, 'MIN'), $map);
	...
	public function avg($join, $column = null, $where = null)
	{
		...
		$query = $this->exec($this->selectContext($map, $join, $column, $where, 'AVG'), $map);
	...
	public function sum($join, $column = null, $where = null)
	{
		...
		$query = $this->exec($this->selectContext($map, $join, $column, $where, 'SUM'), $map);
